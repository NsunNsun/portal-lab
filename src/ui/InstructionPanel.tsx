  ...
  return (
    ...
    >
      ...
      <ol className="mt-3 flex list-decimal flex-col gap-2 pl-5 text-sm" style={{ color: 'var(--ink-2)' }}>
        <li>
          Выберите портал в таблице: сверху — помеченные и неразведанные, затем самые опасные;
          закрытые уходят вниз.
        </li>
        ...
        <li>
          Часть порталов не разведана — отправьте наблюдателя, чтобы узнать их параметры и риск.
        </li>
        <li>
          Жмите «Прошёл час»: время идёт, порталы слабеют, а иногда открываются новые.
        </li>
      </ol>
